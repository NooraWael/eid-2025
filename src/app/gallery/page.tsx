    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-amber-900 to-black flex items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/2 right-10 text-2xl text-amber-400 opacity-30 animate-pulse">✨</div>
        </div>
        
        <div className="text-center relative z-10">
          <div className="text-7xl mb-6 animate-bounce">🌙</div>
          <div className="text-3xl font-semibold text-amber-200 mb-2">Loading Gallery...</div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-amber-900 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 right-32 text-3xl text-amber-400 opacity-15">🏮</div>
        <div className="absolute bottom-32 right-10 text-4xl text-amber-400 opacity-10">✨</div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-amber-200 text-sm mt-1">
                  {submissions.length} beautiful greeting{submissions.length !== 1 ? 's' : ''} from our community
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <div className="relative">
                ...
                />
                <svg className="w-5 h-5 text-amber-300 absolute left-3 top-1/2 transform -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
